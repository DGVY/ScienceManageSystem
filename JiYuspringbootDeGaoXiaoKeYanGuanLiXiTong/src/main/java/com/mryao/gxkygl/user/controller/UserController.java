...
import com.mryao.gxkygl.common.query.Sort;
...
import com.mryao.gxkygl.user.view.AssignmentRoleView;
import com.mryao.gxkygl.user.view.PasswordView;
...
public class UserController {
    ...
    @PutMapping("")
    @AutoErrorhandler
    public Result updateByName(@RequestBody @Validated(V.Update.class)UserView userView,BindingResult bindingResult) throws Exception {
